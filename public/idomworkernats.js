(() => {
  ...
  var require_nats = __commonJS((exports, module) => {
    __markAsModule(exports);
    __export(exports, {
      AckPolicy: () => AckPolicy1,
      AdvisoryKind: () => AdvisoryKind1,
      Bench: () => Bench1,
      Connect: () => Connect1,
      DataBuffer: () => DataBuffer1,
      DebugEvents: () => DebugEvents1,
      DeliverPolicy: () => DeliverPolicy1,
      DenoBuffer: () => DenoBuffer1,
      DiscardPolicy: () => DiscardPolicy1,
      Empty: () => Empty1,
      ErrorCode: () => ErrorCode1,
      Events: () => Events1,
      Heartbeat: () => Heartbeat1,
      INFO: () => INFO1,
      JSONCodec: () => JSONCodec1,
      JsHeaders: () => JsHeaders1,
      Kind: () => Kind1,
      MAX_SIZE: () => MAX_SIZE1,
      Match: () => Match1,
      Metric: () => Metric1,
      MsgHdrsImpl: () => MsgHdrsImpl1,
      MsgImpl: () => MsgImpl1,
      MuxSubscription: () => MuxSubscription1,
      NatsConnectionImpl: () => NatsConnectionImpl1,
      NatsError: () => NatsError1,
      Nuid: () => Nuid1,
      Parser: () => Parser1,
      ProtocolHandler: () => ProtocolHandler1,
      ReplayPolicy: () => ReplayPolicy1,
      Request: () => Request1,
      RetentionPolicy: () => RetentionPolicy1,
      State: () => State1,
      StorageType: () => StorageType1,
      StringCodec: () => StringCodec1,
      SubscriptionImpl: () => SubscriptionImpl1,
      Subscriptions: () => Subscriptions1,
      TD: () => TD1,
      TE: () => TE1,
      TypedSubscription: () => TypedSubscription1,
      canonicalMIMEHeaderKey: () => canonicalMIMEHeaderKey1,
      checkOptions: () => checkOptions1,
      checkUnsupportedOption: () => checkUnsupportedOption1,
      connect: () => connect1,
      consumerOpts: () => consumerOpts1,
      createInbox: () => createInbox1,
      credsAuthenticator: () => credsAuthenticator1,
      deferred: () => deferred1,
      delay: () => delay1,
      extend: () => extend1,
      extractProtocolMessage: () => extractProtocolMessage1,
      headers: () => headers1,
      isFlowControlMsg: () => isFlowControlMsg1,
      isHeartbeatMsg: () => isHeartbeatMsg1,
      isIP: () => isIP1,
      jwtAuthenticator: () => jwtAuthenticator1,
      millis: () => millis1,
      nanos: () => nanos1,
      nkeyAuthenticator: () => nkeyAuthenticator1,
      nkeys: () => mod,
      nuid: () => nuid1,
      parseIP: () => parseIP1,
      readAll: () => readAll1,
      render: () => render1,
      setTransportFactory: () => setTransportFactory1,
      timeout: () => timeout1,
      toJsMsg: () => toJsMsg1,
      writeAll: () => writeAll1
    });
...
`);
    ...
    function isHeartbeatMsg1(msg3) {
      return isFlowControlMsg1(msg3) && msg3.headers?.description === "Idle Heartbeat";
    }
...
`;
    ...
    var Bench1 = class {
      ...
      processMetrics() {
        const nc8 = this.nc;
        const {lang, version} = nc8.protocol.transport;
    ...
    function nkeyAuthenticator1(seed1) {
      return (nonce1) => {
        ...
        const kp = seed1 ? mod.fromSeed(seed1) : void 0;
        const nkey = kp ? kp.getPublicKey() : "";
        const challenge = TE1.encode(nonce1 || "");
        const sigBytes = kp !== void 0 && nonce1 ? kp.sign(challenge) : void 0;
  ...
  var import_nats = __toModule(require_nats());
